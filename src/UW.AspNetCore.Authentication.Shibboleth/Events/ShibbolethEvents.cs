...
public class ShibbolethEvents
{
    ...
    /// <summary>
    /// Invoked when there is a Shibboleth failure.
    /// </summary>
    public virtual Task ShibbolethFailure(ShibbolethFailureContext context) => OnShibbolethFailure(context);

    /// <summary>
    /// Invoked if exceptions are thrown during request processing. The exceptions will be re-thrown after this event unless suppressed.
    /// </summary>
    public Func<ShibbolethFailureContext, Task> OnShibbolethFailure { get; set; } = context => Task.CompletedTask;

    /// <summary>
    /// Invoked after the remote ticket has been received.
    /// </summary>
    public Func<ShibbolethTicketReceivedContext, Task> OnTicketReceived { get; set; } = context => Task.CompletedTask;

    /// <summary>
    /// Invoked after the remote ticket has been received.
    /// </summary>
    public virtual Task TicketReceived(ShibbolethTicketReceivedContext context) => OnTicketReceived(context);
}
